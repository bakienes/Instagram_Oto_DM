...
if ($Sayfa < 1) { $Sayfa = 1;} 
$Say   = $db->query("select * from numara order by id asc");
...
$GorunenSayfa   = 5; 
$Makale = $db->query("select * from numara order by id asc limit $Goster,$Limit");
...
<?php include "../../app/config/header.php"; ?>
  <div class="page-content">
    <div class="content container">
      <div class="row">
        <div class="col-lg-12">
          <h2 class="page-title">Numara istatiskleri </h2>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-12">
...
<div class="bottom-nav footer"> Sky Türk Oto Numara Panel</div>
