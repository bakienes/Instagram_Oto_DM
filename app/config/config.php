...
class Db
{
    ...
    // MySQL ADINIZI DB AD GIBI GECER
    protected $dbUsername = 'sky';

    // MySQL ŞİFRE
    protected $dbPassword = 'sky';

    // MySQL Veritabanı Adı
    protected $dbName = 'sky'; //BEN GENELDE IKISINI AYNI YAPARIM  UNUTMAYAYIM DIYE

    // VE DATABASE BAGLANTI
...
try{ 
   $db = new PDO("mysql:host=$dbHost;dbname=$dbName;charset=utf8", $dbUsername,$dbPassword); //veri tabını baglantısı
